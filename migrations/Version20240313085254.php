 ...
 */
final class Version20240313085254 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participant DROP is_verified, CHANGE roles roles VARCHAR(255) NOT NULL');
